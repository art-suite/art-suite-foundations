...
(function() {
  ...
  module.exports = FieldTypes = {
    ...
    url: {
      validate: function(v) {
        return isString(v) && v.match(urlWithOptionalProtocolRegExp);
      },
      preprocess: function(v) {
