    ...
    (
      ...
      return (RestClient = Caf.defClass(
        ...
        function(RestClient, classSuper, instanceSuper) {
          ...
          this.getArrayBuffer = function(url, options) {
          ...
          this.deleteJson = function(url, options) {
          ...
          this.restRequest = function(options) {
            return RestClient.singleton.restRequest(options);
          };
          this.restJsonRequest = function(options) {
            return RestClient.singleton.restJsonRequest(options);
          };
          this.prototype.get = function(url, options) {
            return this.restRequest(merge(options, { verb: "GET", url }));
          };
          this.prototype.put = function(url, data, options) {
            return this.restRequest(merge(options, { verb: "PUT", url, data }));
          };
          this.prototype.post = function(url, data, options) {
            return this.restRequest(
              merge(options, { verb: "POST", url, data })
            );
          };
          this.prototype.delete = function(url, options) {
            return this.restRequest(merge(options, { verb: "DELETE", url }));
          };
          this.prototype.getArrayBuffer = function(url, options) {
            return this.restRequest(
              merge(options, { verb: "GET", url, responseType: "arraybuffer" })
            );
          };
          this.prototype.getJson = function(url, options) {
            return this.restJsonRequest(merge(options, { verb: "get", url }));
          };
          this.prototype.deleteJson = function(url, options) {
            return this.restJsonRequest(
              merge(options, { verb: "delete", url })
            );
          };
          this.prototype.putJson = function(url, data, options) {
            return this.restJsonRequest(
              merge(options, { verb: "put", url, data })
            );
          };
          this.prototype.postJson = function(url, data, options) {
            return this.restJsonRequest(
              merge(options, { verb: "post", url, data })
            );
          };
          this.prototype.restRequest = function(options) {
            ...
            if (formData) {
              ...
              body = new FormData();
              Caf.each2(formData, (v, k) => body.append(k, v));
            } else {
              body =
                (Caf.exists(body) &&
                  Caf.isF(body.toArrayBuffer) && body.toArrayBuffer()) ||
                body;
            }
            if (method === "GET" && body) {
              log.error({
            ...
            return Promise.then(() => {
              ...
              if (verb === "GET" && options.data) {
                options = merge(options, {
                  url: appendQuery(
                    options.url,
                    Caf.object(data, v => JSON.stringify(v))
                  )
                });
                data = null;
              } else {
          ...
          this.prototype._normalizedRestRequest = function(options) {
            let method,
              url,
              body,
              headers,
            ...
            return new Promise((resolve, reject) => {
              let fail,
                ...
                getResponse,
                requestResolved,
                initialProgressCalled,
                lastProgressEvent,
                progressCallbackInternal;
              fail = props =>
                reject(
                  new RequestError(
                    merge(props, {
                ...
                return (() => {
                  try {
                    ...
                    return {
                      ...
                      message: `ArtRestClient: Error parsing server's response: ${Caf.toString(
                        error
                      )}\nrawResponse: ${Caf.toString(request.response)}`
                    };
                  }
                })();
              };
              ...
              Caf.each2(headers, (v, k) => request.setRequestHeader(k, v));
              ...
              request.addEventListener("load", event => {
                let decodedHttpStatus, httpStatus, message;
                requestResolved = true;
                decodedHttpStatus = decodeHttpStatus(
                  (httpStatus = request.status)
                );
                return !(
                  decodedHttpStatus.status === success &&
                  (() => {
                    try {
                      resolve(getResponse());
                      return true;
              ...
              if (verbose) {
                log({ ArtRestClient: { method, url, headers } });
              }
