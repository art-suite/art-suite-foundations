...
Caf.defMod(module, () => {
  ...
  return (UseragentRegExp = Caf.defClass(
    ...
    function (UseragentRegExp, classSuper, instanceSuper) {
      ...
      this.isWebSpiderRegExp =
        /Googlebot|GoogleWebPreview|GooglePageSpeedInsights|Bingbot|Yahoo.*Slurp|DuckDuckBot|Baiduspider|YandexBot|Exabot|facebot|facebookexternalhit|alexa.com/i;
    }
  ));
});
