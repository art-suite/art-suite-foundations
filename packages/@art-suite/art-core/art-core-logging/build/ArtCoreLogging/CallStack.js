...
(function() {
  var CallStack, formattedInspect, isString, parseUrl;

  isString = require('@art-suite/art-core-types').isString;

  parseUrl = require('@art-suite/art-core-strings').parseUrl;
  ...
  module.exports = CallStack = (function() {
    ...
    CallStack.errorToString = function(error) {
      return (error != null ? error.error : void 0) || (error != null ? error.message : void 0) || (isString(error) && error) || formattedInspect(error);
    };
