...
{peek} = require '@art-suite/art-core-arrays'
{merge} = require '@art-suite/art-core-objects'
{stripAnsi, red, yellow} = require '@art-suite/art-core-terminal-colors'

Inspect = require './Inspect/namespace'
{callStack} = require './CallStack'

{deepResolve, containsPromises} = require '@art-suite/art-core-promises'
{isNode, getEnv} = require '@art-suite/art-core-environment'

{disableLog} = getEnv()

module.exports = class Log
  # autodetect context from
  #   stack (grabbed with callStack()). Ignores stack[0]
