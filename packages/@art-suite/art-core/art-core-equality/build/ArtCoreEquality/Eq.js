...
(function() {
  var Eq, compare, compareArray, compareObject, compareStack, floatTrue0, isDate, isNumber, isString, min, objectKeyCount, plainObjectsDeepEq, plainObjectsDeepEqArray, plainObjectsDeepEqObject, ref, remove,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  remove = require('@art-suite/art-core-arrays').remove;

  objectKeyCount = require('@art-suite/art-core-objects').objectKeyCount;

  floatTrue0 = require('@art-suite/art-core-math').floatTrue0;

  ref = require('@art-suite/art-core-types'), isString = ref.isString, isNumber = ref.isNumber, isDate = ref.isDate;

  min = Math.min;

  compareStack = [];

  plainObjectsDeepEqArray = (function(_this) {
    return function(a, b) {
      var av, i, j, len1;
  ...
  plainObjectsDeepEqObject = (function(_this) {
    return function(a, b) {
      var aLength, av, bv, k;
      aLength = 0;
      for (k in a) {
        ...
        aLength++;
        bv = b[k];
        if (!((bv !== void 0 || b.hasOwnProperty(k)) && plainObjectsDeepEq(av, bv))) {
          return false;
        }
      }
  ...
  plainObjectsDeepEq = (function(_this) {
    return function(a, b) {
      ...
      if (a === b) {
        ...
        if (a.eq || (_isA = _constructor === Array) || (_isB = _constructor === Object)) {
          try {
            ...
            switch (false) {
              case !_isA:
                return plainObjectsDeepEqArray(a, b);
              case !_isB:
                return plainObjectsDeepEqObject(a, b);
              default:
                return a.eq(b);
            }
          } finally {
  ...
  compareArray = (function(_this) {
    return function(a, b, recursionBlockArray, compareFunctionsAsStrings) {
      ...
      for (i = j = 0, ref1 = Math.min(aLength, bLength); j < ref1; i = j += 1) {
        av = a[i];
        bv = b[i];
        if (0 !== (val = compare(av, bv, recursionBlockArray, compareFunctionsAsStrings))) {
          return val;
        }
      }
    ...
    return function(a, b, recursionBlockArray, compareFunctionsAsStrings) {
      ...
      if ((a != null) && (b != null) && a.constructor === (_constructor = b.constructor)) {
        ...
        if (_constructor === Array) {
          return compareArray(a, b, recursionBlockArray, compareFunctionsAsStrings);
        }
        if (_constructor === Object) {
          return compareObject(a, b, recursionBlockArray, compareFunctionsAsStrings);
        }
  ...
  module.exports = Eq = (function() {
    ...
    Eq.compare = function(a, b, recursionBlockEnabled, compareFunctionsAsStrings) {
      return compare(a, b, recursionBlockEnabled && [], compareFunctionsAsStrings);
    };

    Eq.plainObjectsDeepEq = function(a, b) {
      try {
        return plainObjectsDeepEq(a, b);
      } finally {
        compareStack = [];
      }
    };
