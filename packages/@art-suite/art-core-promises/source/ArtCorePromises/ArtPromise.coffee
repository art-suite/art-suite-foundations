...
###
module.exports = class ArtPromise
  ...
  @invert: (promise) ->
    promise.then (e) ->
      throw new Error "ArtCorePromises.invert: promise should have been rejected; instead it resolved with #{e}"
    , (v) -> v
