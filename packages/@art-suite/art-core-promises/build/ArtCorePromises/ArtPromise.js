...
(function() {
  var ArtPromise, BlueBirdPromise, Promise, deepEach, deepMap, isFunction, isPlainObject, isPromise, k, ref, v,
    slice = [].slice;

  Promise = BlueBirdPromise = require("bluebird");

  ref = require('@art-suite/art-core-types'), deepMap = ref.deepMap, deepEach = ref.deepEach, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject, isPromise = ref.isPromise;
