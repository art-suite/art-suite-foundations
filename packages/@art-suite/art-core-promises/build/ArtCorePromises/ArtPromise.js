...
(function() {
  var ArtPromise, BlueBirdPromise, Promise, deepEach, deepMap, isFunction, isPlainObject, isPromise, k, ref, ref1, v,
    slice = [].slice;

  Promise = BlueBirdPromise = require("bluebird");

  ref = require('@art-suite/art-core-types'), isFunction = ref.isFunction, isPlainObject = ref.isPlainObject, isPromise = ref.isPromise;

  ref1 = require('@art-suite/art-core-objects'), deepMap = ref1.deepMap, deepEach = ref1.deepEach;
...
//# sourceMappingURL=ArtPromise.js.map
