          ...
          return this.toHelpString(
            !commandSpecificHelp
              ? `${Caf.toString(
                  ...
                  colors.green(__webpack_require__(/*! path */ 16).basename(startFile))
                )} ${Caf.toString(
