...
(function() {
  var ArtConfig, BaseObject, ConfigRegistry, Promise, clone, compactFlatten, deepMerge, defineModule, expandPathedProperties, formattedInspect, inspect, isPlainObject, isString, log, merge, mergeInto, parseQuery, pushIfNotPresent, ref, upperCamelCase,
  ...
  defineModule(module, ConfigRegistry = (function(superClass) {
    ...
    ConfigRegistry.configure = function() {
      ...
      return ArtConfig.configure.apply(ArtConfig, args);
    };
