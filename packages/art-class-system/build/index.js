...
module.exports = BaseClass = (function(superClass) {
  ...
  BaseClass.postCreate = function(options) {
    var ref;
    this.namespacePath = (this.namespace = (ref = this._namespace) != null ? ref : null) ? this.namespace.namespacePath + "." + this.getName : null;
