...
# file: root/namespace.coffee

Neptune = require 'neptune-namespaces'
module.exports = Neptune.Root ||
Neptune.addNamespace 'Root', class Root extends Neptune.Base
  ;

# generated by Neptune Namespaces v1.x.x
# file: root/index.coffee

module.exports = require './namespace'
require './MyNamespace'

# generated by Neptune Namespaces v1.x.x
# file: root/MyNamespace/namespace.coffee

Root = require '../namespace'
module.exports = Root.MyNamespace ||
Root.addNamespace 'MyNamespace', class MyNamespace extends Neptune.Base
  ;

# generated by Neptune Namespaces v1.x.x
# file: root/MyNamespace/index.coffee

module.exports = require './namespace'
.includeInNamespace require './my_namespace'
```
