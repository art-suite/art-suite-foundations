...
if (__webpack_require__(/*! ./use-build */ 3)) { // use build
  module.exports = __webpack_require__(/*! ./build/generator */ 4);
} else {
  __webpack_require__(/*! ./register */ 14);
  module.exports = __webpack_require__(/*! ./source/NeptuneNamespaces/Generator */ 15);
}
...
if (__webpack_require__(/*! ./use-build */ 3)) { // use build
  ...
  __webpack_require__(/*! ./register */ 12);
  module.exports = __webpack_require__(/*! ./source/NeptuneNamespaces/Generator */ 15);
}
...
module.exports = __webpack_require__(/*! glob-promise */ 6 /* ABC - not inlining fellow NPM */);
...
module.exports = __webpack_require__(/*! fs-extra */ 7 /* ABC - not inlining fellow NPM */);
...
module.exports = __webpack_require__(/*! path */ 8 /* ABC - not inlining fellow NPM */);
...
module.exports = __webpack_require__(/*! colors */ 9 /* ABC - not inlining fellow NPM */);
...
module.exports = __webpack_require__(/*! art-standard-lib/Core */ 10 /* ABC - not inlining fellow NPM */);
...
module.exports = __webpack_require__(/*! neptune-namespaces */ 11 /* ABC - not inlining fellow NPM */);
...
__webpack_require__(/*! coffee-script/register */ 13);
__webpack_require__(/*! caffeine-script/register */ 14);
...
module.exports = __webpack_require__(/*! coffee-script/register */ 12 /* ABC - not inlining fellow NPM */);

/***/ }),
/* 14 */
/*!*******************************************************************************************!*\
  !*** external "require('caffeine-script/register' /* ABC - not inlining fellow NPM *_/)" ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __webpack_require__(/*! caffeine-script/register */ 13 /* ABC - not inlining fellow NPM */);
...
Caf.defMod(module, () => {
  return Caf.importInvoke(
    ...
    [
      ...
      __webpack_require__(/*! ./Generators */ 21),
      __webpack_require__(/*! ./PackageRoot */ 26),
      { NamespaceStructure: __webpack_require__(/*! ./NamespaceStructure */ 27) }
    ],
    (
      getPackageRoot,
      Path,
...
Caf.defMod(module, () => {
  let out;
  out = {
    glob: __webpack_require__(/*! glob-promise */ 6),
    fsp: __webpack_require__(/*! fs-extra */ 7),
    Path: __webpack_require__(/*! path */ 8)
  };
  Caf.object(__webpack_require__(/*! ./Helper */ 18), null, null, out);
  Caf.object(__webpack_require__(/*! ./MiniFoundation */ 20), null, null, out);
  return out;
});
...
version = __webpack_require__(/*! ../../package.json */ 19).version;

ref = __webpack_require__(/*! ./MiniFoundation */ 20), log = ref.log, upperCamelCase = ref.upperCamelCase, fileWithoutExtension = ref.fileWithoutExtension, peek = ref.peek, arrayWithoutLast = ref.arrayWithoutLast, pad = ref.pad;
...
(module.exports = __webpack_require__(/*! ./namespace */ 22))

.addModules({
  IndexJsGenerator:     __webpack_require__(/*! ./IndexJsGenerator */ 24),
  NamespaceJsGenerator: __webpack_require__(/*! ./NamespaceJsGenerator */ 25)
});
...
module.exports = __webpack_require__(/*! ../namespace */ 23).addNamespace(
  'Generators',
  class Generators extends Neptune.PackageNamespace {}
);
...
module.exports = __webpack_require__(/*! neptune-namespaces */ 11).addNamespace(
  'NeptuneNamespaces',
  (class NeptuneNamespaces extends Neptune.PackageNamespace {})
  ._configureNamespace(__webpack_require__(/*! ../../package.json */ 19))
);
__webpack_require__(/*! ./Generators/namespace */ 22);
...
fs = __webpack_require__(/*! fs-extra */ 7);

normalizeDirectory = __webpack_require__(/*! ./MiniFoundation */ 20).normalizeDirectory;
...
ref = __webpack_require__(/*! ./MiniFoundation */ 20), upperCamelCase = ref.upperCamelCase, peek = ref.peek, pushIfUnique = ref.pushIfUnique, log = ref.log, merge = ref.merge, arrayWithoutLast = ref.arrayWithoutLast, fileWithoutExtension = ref.fileWithoutExtension;

ref1 = __webpack_require__(/*! ./Helper */ 18), globalNamespaceName = ref1.globalNamespaceName, shouldNotAutoload = ref1.shouldNotAutoload, shouldNotNamespace = ref1.shouldNotNamespace, shouldIncludeInNamespace = ref1.shouldIncludeInNamespace, toFilename = ref1.toFilename, toModuleName = ref1.toModuleName;
...
__webpack_require__(/*! coffee-script/register */ 12);
__webpack_require__(/*! caffeine-script/register */ 13);
...
module.exports = require('caffeine-script/register' /* ABC - not inlining fellow NPM */);
...
module.exports = JSON.parse("{\"author\":\"Shane Brinkman-Davis Delamore, Imikimi LLC\",\"bin\":{\"neptune-namespaces\":\"./nn\",\"nn\":\"./nn\"},\"bugs\":\"https:/github.com/art-suite/art-suite-foundations/issues\",\"dependencies\":{\"art-build-configurator\":\"*\",\"neptune-namespaces-runtime\":\"*\"},\"description\":\"Generate index.coffee and namespace.coffee files from directory structures\",\"devDependencies\":{\"art-testbench\":\"*\",\"case-sensitive-paths-webpack-plugin\":\"^2.2.0\",\"chai\":\"^4.2.0\",\"coffee-loader\":\"^0.7.3\",\"css-loader\":\"^3.0.0\",\"json-loader\":\"^0.5.7\",\"mocha\":\"^7.0.0\",\"mock-fs\":\"^4.10.0\",\"script-loader\":\"^0.7.2\",\"style-loader\":\"^1.0.0\",\"webpack\":\"^4.39.1\",\"webpack-cli\":\"*\",\"webpack-dev-server\":\"^3.7.2\",\"webpack-merge\":\"^4.2.1\",\"webpack-node-externals\":\"^1.7.2\",\"webpack-stylish\":\"^0.1.8\"},\"homepage\":\"https://github.com/art-suite/art-suite-foundations\",\"license\":\"ISC\",\"name\":\"neptune-namespaces\",\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/art-suite/art-suite-foundations.git\"},\"scripts\":{\"build\":\"webpack --progress\",\"start\":\"webpack-dev-server --hot --inline --progress --env.devServer\",\"test\":\"nn -s;mocha -u tdd\",\"testInBrowser\":\"webpack-dev-server --progress --env.devServer\"},\"version\":\"4.1.1\"}");
