...
module.exports = class NamespaceBaseClass
  ...
  # as __super__ or any of the property names in the NamespaceBaseClass namespace.
  ...
  @_addToNamespace: (propName, addingFrom) ->
    # Art.Foundation defines a more general-purpose inspect; it should replace Neptune.NamespaceBaseClass.inspect
