...
(function() {
  var DomConsole, Mocha, NestedSuites, Promise, assertLib, configure, defineSuitesByNamespaces, defineSuitesByObjectStructure, isArray, isFunction, isNode, isPlainObject, isPromise, log, merge, ref,
    slice = [].slice;
  ...
  NestedSuites = (function() {
    ...
    NestedSuites.prototype.groupTestSuites = function(defineAllTests) {
      ...
      return Promise.resolve(defineAllTests(assertLib)).then(defineSuitesByNamespaces).then((function(_this) {
        return function() {
