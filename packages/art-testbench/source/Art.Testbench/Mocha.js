...
(function() {
  var DomConsole, Mocha, NestedSuites, Promise, chai, configure, defineSuitesByNamespaces, defineSuitesByObjectStructure, isArray, isFunction, isNode, isPlainObject, log, merge, ref,
    slice = [].slice;
