...
(function() {
  var DomConsole, Mocha, NestedSuites, Promise, configure, defineSuitesByNamespaces, defineSuitesByObjectStructure, isArray, isFunction, isNode, isPlainObject, isPromise, log, merge, ref,
    slice = [].slice;
