...
(function() {
  var DomConsole, Mocha, NestedSuites, Promise, chai, cleanErrorStack, configure, defineSuitesByNamespaces, defineSuitesByObjectStructure, isArray, isFunction, isNode, isPlainObject, isPromise, log, merge, ref,
    slice = [].slice;
  ...
  cleanErrorStack = require('./ErrorExtensions').cleanErrorStack;
  ...
  module.exports = Mocha = (function() {
    ...
    Mocha.assert = chai.assert;

    Mocha.test = function() {
      var name, rest, test;
      name = arguments[0], test = arguments[1], rest = 3 <= arguments.length ? slice.call(arguments, 2) : [];
      return global.test.apply(global, [name, function() {
        var error, p;
        p = (function() {
          try {
            return test();
